...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/logo-nav.png" rel="icon">
  ...
  <link href="assets/css/names.css" rel="stylesheet">
...
<body>
  ...
  <div id="progressive">
    <div>
      <!-- <img class="img-fluid " src="assets/img/Asset 21.png" alt=""> -->
      <img class="img-fluid " src="assets/img/loader.gif" alt="">
    </div>
    <!-- <div class="progress " id="shadow">
      <div class="progress-bar progress-bar-danger six-sec-ease-in-out" role="progressbar" data-transitiongoal="100">
      </div>
    </div> -->
  </div>
  ...
  <div id="container" style="visibility: hidden;">
    ...
    <section id="hero">
      <div class="hero-container">
        <a href="index.html" class="hero-logo" data-aos="zoom-in"><img src="assets/img/Asset 11.png" alt=""></a>
        <a href="index.html" class="hero-logo" data-aos="zoom-in"><img src="assets/img/Asset 21.png" alt=""></a>
        <!-- partial:index.partial.html -->

        <h1 data-aos="zoom-in" class="">
          <p>
            <span class="word w1" style="font-size: x-large; padding-left: -50px;"> Beedi </span>
            <span class="word w2" style="font-size: large;">Safety Matches </span>
            <!-- <span class="word w3" style="font-size: larger;">Mouth Freshner</span> -->
        ...
        <a data-aos="fade-up" data-aos-delay="200" href="#about" class="btn-get-started scrollto">About us</a>
      </div>
    </section><!-- End Hero -->
      ...
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar mx-auto">
          <ul>
            ...
            <li class="logo-mob"> <a href=" index.html"><img src="assets/img/logo-nav.png" alt="" class="img-fluid"></a>
            </li>
    ...
    <main id="main">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-6" data-aos="fade-right">
              <img src="assets/img/GY-Beedi-Kattu (1).png" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 " data-aos="fade-left">
              <div class="content card card-custom bg-light  ">
                <h3>We have been in the field of Beedi leaves and tobacco business for the past 25 years. As this is a
                  small-scale cottage industry and our presence is in select parts of Tamil Nadu, the quality control is
                  fully under our own supervision. The rural workers are skillful and efficient and have been in this
                  line of work for decades. Hence the quality of GT Beedi is unparalleled till date and our brand name
                  GT stands for “Good taste”.

                  Our factory is situated in Tirunelveli, one of the oldest centres of Beedi industry. The rural workers
                  know their trade and roll hundreds of Beedi everyday without a dent in the quality. Our motto is to
                  manufacture and deliver the best products in terms of price and quality and to never compromise in
                  taste and flavour.
                </h3>
                <!-- <p class="fst-italic">
      ...
      <!-- ======= About Us Section ======= -->
      <section id="manufacturing" class="">
        <div class="section-title" data-aos="fade-up">
          ...
          <div class="swiper-wrapper">
            <div class="slider-item swiper-slide">
              <div class="slider-image-wrapper">
                <img class="slider-image" src="assets/img/Tobacco Plant.jpg" alt="SliderImg">
              </div>
              <div class="slider-item-content">
                <h1>First Stage</h1>
                <p>The first stage includes sourcing the rich Gujarat and Nippani
                  tobacco.
                </p>
              </div>
            </div>
            <div class="slider-item swiper-slide">
              <div class="slider-image-wrapper">
                <img class="slider-image" src="assets/img/Beedi Rolling.jpg" alt="SliderImg">
              </div>
              <div class="slider-item-content">
                <h1>Second stage</h1>
                <p>The Beedi is rolled with Tendu leaves embedding this mixture in the
                  middle and a small thread is tied at one end.</p>
              </div>
            </div>
            <div class="slider-item swiper-slide">
              <div class="slider-image-wrapper">
                <img class="slider-image" src="assets/img/portfolio/Sun Drying Process of Beedi.JPG" alt="SliderImg">
              </div>
              <div class="slider-item-content">
                <h1>Third stage</h1>
                <p>The rolled Beedies are arranged in a huge tray and roasted in a wood
                  husk/fire oven, this eliminates the moisture if any</p>
              </div>
            </div>
            <div class="slider-item swiper-slide">
              <div class="slider-image-wrapper">
                <img class="slider-image" src="assets/img/Packing Process.JPG" alt="SliderImg">
              </div>
              <div class="slider-item-content">
                <h1>Fourth stage</h1>
                <p>The roasted Beedies are then removed from the oven and then labelled
                  and packed, with our trademark GT branding, which assures the genuineness of the product and the
                  Beedis are ready to deliver.</p>
              </div>
            </div>
          </div>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                <div class="card-box secondary rotate">
                  <img src="assets/img/img-20190821-wa0027-676x450.jpg" alt="" class="img-fluid">
                  <!-- <h10></h10>
                <h11></h11>
                <p></p> -->
                  <button class="btn more"> <a href="product.html">View More</a></button>
                </div>
              </div>
              <div class="swiper-slide  ">
                ...
                <p></p>
                <p></p> -->
                  <button class="btn more"> <a href="product1.html"></a>View More</a></button>
                </div>
              </div>
              <div class="swiper-slide ">
                <div class="card-box secondary rotate">
        ...
        <div class="container px-1">
          ...
          <div id="view-less">
            ...
            <div class="text-center">
              <div class="btn" id="view-more-btn">View More</div>
            </div>
          </div>
          <div id="view-more" class="d-none">
            <div class="row  portfolio-container" data-aos="fade-up" data-aos-delay="200">
              <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                  <img src="assets/img/portfolio/portfolio-1.JPG" class="img-fluid" alt="">
            ...
            <div class="text-center">
              <div class="btn" id="view-less-btn">View Less</div>
            </div>
          </div>
        </div>
  ...
  <div class="swiper-pagination"></div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="member" data-aos="zoom-in">
                ...
                <div class="member-info">
                  ...
                  <p>Animi est delectus alias quam repellendus nihil nobis dolor. Est sapiente occaecati et dolore.
                    Omnis
                    aut ut nesciunt explicabo qui. Eius nam deleniti ut omnis</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="member" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="member-info">
                  ...
                  <p>Aspernatur iste esse aliquam enim et corporis. Molestiae voluptatem aut eligendi quis aut. Libero
                    vel
      ...
      <!-- <section id="faq" class="faq">
        <div class="container">
          ...
          <ul class="faq-list">
            ...
            <li data-aos="fade-up" data-aos-delay="100">
              <a data-bs-toggle="collapse" data-bs-target="#faq2" class="collapsed">Feugiat scelerisque varius morbi
                enim
      ...
      <section id="contact" class="contact section-bg">
        ...
        <div class="row mx-md-5 my-3 px-1">
          ...
          <div class="col-md-4">
            ...
            <div class="info" data-aos="fade-right">
              ...
              <div class="contact-symbols mt-3 ">
                <div class="address d-flex mt-3">
                  <i class="bi bi-geo-alt mt-4"></i>
                  <p>No.2, JP Koil Street,<br>
                    Old washermenpet,<br>
                ...
                <div class="email d-flex mt-3">
                  ...
                  <!-- <h4>Email:</h4> -->
                  <a href="mailto:contact@gtbeedi.com">
                    <p class="mt-1 con-link">contact@gtbeedi.com</p>
                  </a>
                </div>
                ...
                <div class="phone d-flex mt-3">
                  ...
                  <!-- <h4>Call:</h4> -->
                  <a href="tel:+914425973000">
                    <p class="mt-1 con-link">+91 44 25973000</p>
                  </a>
                  <a href="tel:+919444072228">
                    <p class="mt-1 con-link">+ 91 9444072228</p>
                  </a>
                </div>
              </div>
            </div>
          ...
          <!-- <center class="mt-4">
            <a id="enquire-btn" href="https://www.gtbeedi.com/contact.htm" target="_blank">Enquire Now</a>
          </center> -->
          <div class="col-md-8 mt-5 mt-lg-0">
            ...
            <form method="post" role="form" class="php-email-form" id="sms-form" data-aos="fade-left">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="number" name="phno" class="form-control" id="phno" placeholder="Your Phone No" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
    ...
    <footer id="footer">
      ...
      <div class="container footer-bottom clearfix">
        <div class="copyright">
          &copy; Copyright 2021 |<strong><span> Silas & Alison </span></strong>| All Rights Reserved
        </div>
